...
![Repository size](https://img.shields.io/github/repo-size/mavrxlab/lab-manual) ![Release version](https://img.shields.io/github/v/release/mavrxlab/lab-manual?include_prereleases) ![Release date](https://img.shields.io/github/release-date/mavrxlab/lab-manual)
